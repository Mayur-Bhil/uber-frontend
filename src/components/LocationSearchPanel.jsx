...
const LocationSearchPanel = () => {
  ...
  return (
    <div className=''>
        <div className='flex items-center bg-zinc-100 border-2 p-2 active:border-lime-800 justify-start my-3 font-medium  rounded-xl p-'>
            ...
            <h4>248,Near Kapoor's cafe ,Sherians Coding School,Bhoal</h4>
        </div>
