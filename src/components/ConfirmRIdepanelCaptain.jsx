...
const ConfirmRIdepanelCaptain = (props) => {
  return (
    <div >
      <h5
      ...
      <h3 className="text-2xl font- p-2 semibold ">
...
<div className='flex w-full gap-4 justify-between items-center'>
        ...
        <Link to={'/captains/riding'} className="w-full bg-green-500 rounded-xl flex justify-center  p-2 font-semibold text-white active:scale-90 transition duration-150">
          Confirm
        </Link>
...
export default ConfirmRIdepanelCaptain;
